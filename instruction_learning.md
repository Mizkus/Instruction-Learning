...
1.  **Базовый эмбеддинг текста**
    - полученный от универсальной модели _Qwen3-Embedding 0.6B_
    - размерность: **1024**
2.  **Инструкция**
    - напр. «определи тему новости», «определи географическое
      положение»
3.  **Целевой инструктированный эмбеддинг**
    - полученный от _Qwen3-Embedding 0.6B_
    - используется только в обучении как _teacher_
...
Цель: получить сравнимое качество, но _значительно быстрее_.
